  ...
  const categories = [
    {
      ...
      skills: [
        ...
        { id: "javascript", name: "JavaScript", devicon: "devicon-javascript-plain colored", frameworks: ["Next.js", "TypeScript", "Node.js", "React"], projectIds: ["schoolops", "bookingcare", "coursehub", "ecommerce"] },
    ...
    },
    {
      ...
      skills: [
        { id: "nodejs", name: "Node.js", devicon: "devicon-nodejs-plain colored", projectIds: ["schoolops", "coursehub", "ecommerce"] },
        { id: "express", name: "Express.js", devicon: "devicon-express-original colored", projectIds: ["schoolops", "coursehub", "ecommerce"] },
        ...
        { id: "react", name: "React", devicon: "devicon-react-original colored", projectIds: ["schoolops", "bookingcare", "coursehub", "ecommerce"] }
      ]
    },
    {
      ...
      skills: [
        { id: "postgresql", name: "PostgreSQL", devicon: "devicon-postgresql-plain colored", projectIds: ["schoolops", "bookingcare", "coursehub"] },
        ...
        { id: "rawsql", name: "Raw SQL", devicon: "devicon-postgresql-plain colored", projectIds: ["schoolops", "coursehub"] }
      ]
    },
    {
      ...
      skills: [
        ...
        { id: "git", name: "Git", devicon: "devicon-git-plain colored", projectIds: ["schoolops", "bookingcare", "pdf-vision-ocr", "coursehub", "ecommerce", "vietnamese-ocr", "nlp-translation", "stock-ml", "warehouse", "pos"] },
        { id: "github", name: "GitHub", devicon: "devicon-github-original colored", projectIds: ["schoolops", "bookingcare", "pdf-vision-ocr", "coursehub", "ecommerce", "vietnamese-ocr", "nlp-translation", "stock-ml", "warehouse", "pos"] },
