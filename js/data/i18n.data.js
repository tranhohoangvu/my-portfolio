...
window.I18N_DATA = {
  vi: {
    ...
    cv_headline: "Ba hướng. Một mục tiêu.",
    cv_title: "CV",
    ...
    cv_updated_fe: "Cập nhật T9/2026",

    cv_be_title: "Backend Developer Fresher (PDF)",
    ...
    cv_fe_title: "Frontend Developer Fresher (PDF)",
    cv_fe_desc: "Định hướng Frontend: Next.js, React, TypeScript, TailwindCSS & UI component-driven development.",

    cv_btn_view: "Xem",
    cv_btn_download: "Tải xuống",
    cv_preview_hover: "Xem trước",
    cv_stat_versions: "3 Định dạng chuyên sâu",
    ...
    cv_badge_frontend: "Frontend Developer Fresher",
    cv_downloads_be: "52 lượt tải",
    cv_downloads_ai: "38 lượt tải",
    cv_downloads_fe: "28 lượt tải",

    cv_menu_be_title: "Backend Developer Fresher (PDF)",
    cv_menu_be_meta: "TranHoHoangVu_BE.pdf",
    cv_menu_fe_title: "Frontend Developer Fresher (PDF)",
    cv_menu_fe_meta: "TranHoHoangVu_FE.pdf",
    ...
    about_description:
      "Mình là Trần Hồ Hoàng Vũ, tốt nghiệp ngành Khoa học Máy tính tại Đại học Tôn Đức Thắng với kinh nghiệm thực tế về phát triển phần mềm qua kỳ thực tập Kỹ sư phần mềm và các dự án học thuật, thực chiến. Mình thích xây dựng các giải pháp hoàn chỉnh, từ thiết kế hệ thống Backend RESTful APIs, tối ưu cơ sở dữ liệu, xây dựng giao diện Frontend hiện đại (Next.js, React, TypeScript) đến phát triển các quy trình tự động hóa và ứng dụng AI/ML thực tế. Mình đã làm việc thành thạo với Node.js, Express.js, Laravel, Next.js, React và nhiều công nghệ cơ sở dữ liệu khác nhau. Định hướng sắp tới, mình sẵn sàng đảm nhiệm các vị trí Backend Developer Fresher, Frontend Developer Fresher hoặc AI Engineer Fresher, không ngừng học hỏi và mang lại giá trị bền vững cho sản phẩm.",
    about_kicker: "Phát triển Phần mềm • Backend, Frontend & AI",
    about_headline: "Mình xây dựng backend chuẩn chỉ, frontend chỉn chu và pipeline AI thực dụng.",
    ...
    about_pillar_goal_desc: "Backend Developer Fresher (Node.js, Express, Laravel), Frontend Developer Fresher (Next.js, React, TypeScript) & AI Engineer Fresher (PyTorch, Transformers, Computer Vision).",
    ...
    certs_kicker: "🏅 8 Chứng chỉ • 2024 - 2026",
    certs_headline: "Được chứng nhận. Đã xác minh. Sẵn sàng.",
    certs_subtitle: "Các chứng chỉ xác nhận năng lực Trí tuệ nhân tạo (AI), Phân tích dữ liệu, Quản trị sản phẩm, Hệ thống Linux, Agile & Scrum và tiếng Anh.",
    ...
    cert_tag_ms_ai: "AI / Product Management",
    cert_tag_gemini: "Google AI",
    cert_tag_linux: "Linux / OS",
    cert_ms_title: "Microsoft AI Product Manager",
    cert_ms_desc: "Chuyên môn gồm 5 khóa học do Microsoft đào tạo. Phát triển sản phẩm AI cho doanh nghiệp với Copilot, Azure, Power BI, nghiên cứu thị trường, chiến lược đám mây và thiết kế UX/UI.",
    cert_linux_title: "Introduction to Linux (LFS101)",
    cert_linux_desc: "Chứng nhận do The Linux Foundation cấp. Nắm vững kiến thức nền tảng về hệ điều hành Linux, thao tác dòng lệnh (CLI), quản trị hệ thống, kiến trúc mạng, bash shell và bảo mật mã nguồn mở.",
    ...
    cert_gemini_educator_title: "Gemini Certified Educator",
    cert_gemini_educator_desc: "Chứng nhận cấp Chuyên gia giáo dục bởi Google for Education. Xác nhận năng lực ứng dụng nâng cao các mô hình Google AI và Gemini nhằm tối ưu hóa giảng dạy, soạn thảo học liệu và chuyển đổi số giáo dục.",
    cert_gemini_title: "Gemini Certified Student",
    cert_gemini_desc: "Chứng nhận cấp Đại học bởi Google for Education. Đánh giá kiến thức chuyên môn, kỹ năng thực hành và ứng dụng các mô hình Gemini AI trong học tập và công việc.",
    ...
    contact_subtitle: "Sẵn sàng đón nhận cơ hội việc làm Backend Developer Fresher, Frontend Developer Fresher, AI Engineer Fresher hoặc dự án cộng tác mới.",
    contact_avail_badge: "Sẵn sàng nhận việc ngay",
    contact_avail_roles: "Backend • Frontend • AI Engineer Fresher",
    ...
    topic_fe: "🖥️ Tuyển dụng Frontend",
  ...
  en: {
    ...
    cv_headline: "Three CVs. One mission.",
    cv_title: "CV",
    ...
    cv_updated_fe: "Updated Sep 2026",
    ...
    cv_fe_title: "Frontend Developer Fresher (PDF)",
    cv_fe_desc: "Targeted for Frontend Developer roles: Next.js, React, TypeScript, TailwindCSS & UI component-driven development.",

    cv_btn_view: "View",
    cv_btn_download: "Download",
    cv_preview_hover: "Preview",
    cv_stat_versions: "3 Specialized Versions",
    ...
    about_description:
      "My name is Tran Ho Hoang Vu. I'm a Computer Science graduate from Ton Duc Thang University with hands-on experience across full-stack engineering, backend systems, and applied AI through a software engineering internship and real-world projects. I enjoy building end-to-end solutions, from designing robust RESTful APIs and database architectures to crafting responsive, modern frontends (Next.js, React, TypeScript) and practical AI/ML pipelines. I have worked extensively with Node.js, Express.js, Laravel, Next.js, React, and multiple database engines. Looking forward, I am eager to contribute as a Backend Developer Fresher, Frontend Developer Fresher, or AI Engineer Fresher, continuously learning and delivering high-quality software.",
    about_kicker: "Software Engineering • Backend, Frontend & AI",
    about_headline: "I build robust backend services, refined frontend interfaces, and practical AI pipelines.",
    about_chip_1: "Backend APIs",
    ...
    certs_kicker: "🏅 8 Certificates • 2024 - 2026",
    certs_headline: "Certified. Verified. Ready.",
    certs_subtitle: "Credentials validating proficiency in AI & Deep Learning, Data Analytics, AI Product Management, Linux Systems, Software Methodology, and Academic English.",
    certs_tab_all: "All",
    certs_tab_ai: "AI & Deep Learning",
    ...
    cert_tag_linux: "Linux / OS",
    cert_ms_title: "Microsoft AI Product Manager",
    cert_ms_desc: "Professional Certificate consisting of 5 courses by Microsoft. Lead enterprise product development with Copilot, Azure, Power BI, cloud strategy, market research, and UX/UI design.",
    cert_linux_title: "Introduction to Linux (LFS101)",
    cert_linux_desc: "Professional Certificate issued by The Linux Foundation. Demonstrates foundational competence in Linux operating system, command line interface (CLI), system administration, bash shell, and open-source operations.",
    cert_google_title: "Google Data Analytics",
    ...
    cert_gemini_educator_title: "Gemini Certified Educator",
    cert_gemini_educator_desc: "Certified as an Educator by Google for Education. Validating advanced competencies in leveraging Google AI and Gemini models to enhance instructional workflows, content creation, and digital education.",
    cert_gemini_title: "Gemini Certified Student",
    cert_gemini_desc: "Certified at University level by Google for Education. Demonstrates foundational knowledge, competencies, and practical skills in utilizing Google AI and Gemini models.",
    cert_tf_title: "DeepLearning.AI TensorFlow Developer",
    ...
    contact_subtitle: "Open to Backend Developer Fresher, Frontend Developer Fresher, and AI Engineer Fresher opportunities, freelance projects, or tech chats.",
