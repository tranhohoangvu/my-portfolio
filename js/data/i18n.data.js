...
window.I18N_DATA = {
  vi: {
    ...
    certs_kicker: "🏅 3 Chứng chỉ • 2024 - 2026",
    certs_headline: "Được chứng nhận. Đã xác minh. Sẵn sàng.",
    certs_subtitle: "Các chứng chỉ xác nhận năng lực phân tích dữ liệu, phương pháp phát triển phần mềm và trình độ tiếng Anh.",
  ...
  en: {
    ...
    certs_kicker: "🏅 3 Certificates • 2024 - 2026",
    certs_headline: "Certified. Verified. Ready.",
    certs_subtitle: "Credentials validating proficiency in data analytics, software development methodology, and academic English.",
