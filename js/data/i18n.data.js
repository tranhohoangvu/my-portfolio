...
window.I18N_DATA = {
  vi: {
    ...
    certs_kicker: "🏅 7 Chứng chỉ • 2024 - 2026",
    certs_headline: "Được chứng nhận. Đã xác minh. Sẵn sàng.",
    certs_subtitle: "Các chứng chỉ xác nhận năng lực Trí tuệ nhân tạo (AI), Phân tích dữ liệu, Quản trị sản phẩm, Agile & Scrum và tiếng Anh.",
  ...
  en: {
    ...
    certs_kicker: "🏅 7 Certificates • 2024 - 2026",
    certs_headline: "Certified. Verified. Ready.",
    certs_subtitle: "Credentials validating proficiency in AI & Deep Learning, Data Analytics, AI Product Management, Software Methodology, and Academic English.",
    certs_tab_all: "All",
    certs_tab_ai: "AI & Deep Learning",
